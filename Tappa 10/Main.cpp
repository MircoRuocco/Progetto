...
int main()
{
    ...
    // Piattaforme
    std::vector<sf::Vector2f> posizioniPiattaforme = {    
    {1850.f, 400.f},
    {2100.f, 275.f},
    {2200.f, 275.f},
    {3300.f, 400.f},
    ...
    // Jump Pad 
    std::vector<sf::Vector2f> posizioniJumpPad = {
    {2900.f, 490.f}, 
    {4500.f, 490.f}};
    ...
    patternSpike(posizioniOstacoli, 3200.f, 462.5f, 1);
    patternSpike(posizioniOstacoli, 4300.f, 462.5f, 2);
    patternSpike(posizioniOstacoli, 4900.f, 462.5f, 3);
    
    // Spike sopra le piattaforme
    patternSpike(posizioniOstacoli, 3600.f, 312.5f, 1);
    patternSpike(posizioniOstacoli, 4100.f, 312.5f, 1);

    // Tappeto di spike nella sezione navicella
    patternSpike(posizioniOstacoli, 5600.f, 462.5f, 28);
    ...
    // Portale
    world.spawnPortale({5400.f, 390.f});


    // Traguardo
    world.spawnTraguardo({7000.f, 0.f});
